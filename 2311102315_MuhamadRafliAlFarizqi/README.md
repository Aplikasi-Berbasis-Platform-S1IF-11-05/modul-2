...
Pada tugas ini, tabel diminta berada di tengah tanpa CSS. Secara historis, HTML lama menyediakan atribut `align="center"` pada `<table>` untuk memusatkan tabel secara horizontal. Selain itu, tag `<center>` juga merupakan elemen HTML jadul yang dapat digunakan untuk memusatkan konten. Atribut `border`, `cellpadding`, dan `cellspacing` juga termasuk pendekatan lama yang dahulu umum dipakai sebelum CSS menjadi standar utama untuk pengaturan tampilan.
...
<head>
    ...
    <title>Tabel - 2311102315 Muhamad Rafli Al Farizqi</title>
</head>
<body>
    <center>
        <h2>Daftar Mahasiswa</h2>
        <h4>2311102315 - Muhamad Rafli Al Farizqi</h4>
    </center>
    <table align="center" border="1" cellpadding="10" cellspacing="0">
        ...
        <tr>
            ...
            <td>Muhamad Rafli Al Farizqi</td>
            <td align="center">2311102315</td>
            <td align="center">S1IF-11-05</td>
        </tr>
        <tr>
            <td align="center">2</td>
            <td>Grashela Ayudia Prameswari</td>
            <td align="center">2311102318</td>
            <td align="center">S1IF-11-05</td>
        </tr>
        <tr>
            <td align="center">3</td>
            <td>Hamka Zaenul Ardi</td>
            <td align="center">2311102081</td>
            <td align="center">S1IF-11-05</td>
        </tr>
        <tr>
            <td align="center">4</td>
            <td>Dedi Agung Prabowo</td>
            <td align="center">2311102099</td>
            <td align="center">S1IF-11-05</td>
        </tr>
        <tr>
            <td align="center">5</td>
            <td>Rasyid Nafsyarie</td>
            <td align="center">2311102011</td>
            <td align="center">S1IF-11-05</td>
        </tr>
    </table>
</body>
...
<img alt="Screenshot Output Tabel HTML" src="assets/tugas2-html.png" />
